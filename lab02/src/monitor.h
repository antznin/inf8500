...
class monitor : public simple_bus_slave_if,
				public sc_module
{
public:
	...
	******************************************************************** */
	...
	// MODULE CONSTRUCTOR
	******************************************************************** */
	monitor(sc_module_name name_, unsigned int start_address, unsigned int end_address, unsigned int nr_wait_states)
		: sc_module(name_), m_start_address(start_address), m_end_address(end_address), m_nr_wait_states(nr_wait_states), packet_dispatched(1), m_wait_count(-1)
	{
